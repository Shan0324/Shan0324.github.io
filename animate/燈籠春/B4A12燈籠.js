...
lib.ssMetadata = [
		{name:"B4A12燈籠_atlas_1", frames: [[0,1147,333,316],[1119,969,82,230],[1119,0,80,967],[0,0,1117,1145]]}
];
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["B4A12燈籠_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.B4A12燈籠 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/B4A12燈籠_atlas_1.png", id:"B4A12燈籠_atlas_1"}
	],
	preloads: []
};
